...
public class PageAction {
	...
	public void page2(HttpServletRequest request, int count, int limit, int limitPage, int page, String pageUrl1, String pageUrl2) {
		...
		if(endPage > maxPage) 
			endPage = maxPage;
		String pageUrl = pageUrl1 + pageUrl2;
